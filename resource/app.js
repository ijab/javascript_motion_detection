(function() {
	...
	function loadSounds() {
		...
		bufferLoader = new BufferLoader(soundContext,
			[
				'resource/sounds/note1.mp3',
				'resource/sounds/note2.mp3',
				'resource/sounds/note3.mp3',
				'resource/sounds/note4.mp3',
				'resource/sounds/note5.mp3',
				'resource/sounds/note6.mp3',
				'resource/sounds/note7.mp3',
				'resource/sounds/note8.mp3'
			],
			finishedLoading
		);
		bufferLoader.load();
